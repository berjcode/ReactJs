        ...
        <Row style={{ height: "300px", margin: "" }}>
          <Col md={2}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }} >
              ...
              <button className="ui  blue  large button m-4" style={{ width: "200px" }}>Güncelleme Yap</button>
            </div>
          ...
          <Col md={10} >
            ...
            <div style={{ boxShadow: '5px 5px 5px black' }}>
              <DataTable columns={columns}
                data={data} selectableRows fixedHeader pagination onSelectedRowsChange={HandleSelectedRows} paginationPerPage={8} >
